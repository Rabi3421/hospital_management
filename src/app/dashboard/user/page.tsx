    ...
    return (
        <div className="glass-card p-3 sm:p-5 rounded-2xl">
            <div className="flex items-start justify-between">
                <div>
                    <p className="text-navy/50 text-xs sm:text-sm mb-1">{label}</p>
        ...
        <div className="flex w-full">
            ...
            <main className="flex-1 min-w-0 p-4 sm:p-6 lg:p-8 pt-16 lg:pt-8 overflow-x-hidden">
                ...
                <div className="mb-5 sm:mb-8">
                    ...
                    <p className="text-navy/50 text-sm mt-1">Here&apos;s your health overview for today.</p>
                </div>

                {statsLoading ? (
                    <div className="grid grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-5 mb-5 sm:mb-8">
                        {[...Array(4)].map((_, i) => (
                            <div key={i} className="glass-card p-3 sm:p-5 rounded-2xl animate-pulse">
                                <div className="h-3 sm:h-4 bg-navy/10 rounded mb-3 w-20 sm:w-24" />
                                <div className="h-6 sm:h-8 bg-navy/10 rounded w-12 sm:w-16" />
                            </div>
                        ))}
                    </div>
                ) : stats ? (
                    <>
                        ...
                        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6">
                            ...
                            <div className="xl:col-span-2 glass-card rounded-2xl p-4 sm:p-6">
                                <h2 className="font-fraunces text-base sm:text-lg font-semibold text-navy mb-4 sm:mb-5">Monthly Visits</h2>
                        ...
                        {/* Recent activity */}
                        <div className="mt-4 sm:mt-6 glass-card rounded-2xl p-4 sm:p-6">
                            <h2 className="font-fraunces text-base sm:text-lg font-semibold text-navy mb-4 sm:mb-5">Recent Activity</h2>
